...
function showSelected($peli)
{
    if (isset($_GET["selected"])) {
        $selected = $_GET["selected"];
        
        if ($selected == "") {
            echo "El campo 'selected' no puede estar vacío";
        } elseif (isset($peli[$selected])) {
            echo $peli[$selected];
        } else {
            echo "Índice no válido en el array de películas";
        }
    } else {
        echo "Selected no está en el campo de búsqueda";
    }
}
